import { CancelButton, InputLabel, StatusSelectComponent, SubmitButton, TextAreaInputComponent, TextInputComponent } from "../../components/common/form/input.component";
  ...
  return (
    <form onSubmit={handleSubmit(submitEvent)}>
      ...
      <div className="btnn flex w-[35%] flex-wrap justify-between">
        ...
        <CancelButton loading={loading} href={"/admin/product"}>
